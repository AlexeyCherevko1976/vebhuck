...
<div id="app" class="container-fluid">
	<div class="writeData1" id="writeData1"></div>
	<div class="writeData2" id="writeData2"></div>
<!--
...
<script type="text/javascript" src="js/vebhuch.js"></script>

<script>
    $(document).ready(function () {
	
	$('#writeData2').append(writeDataExample());
		BX24.init(function(){
